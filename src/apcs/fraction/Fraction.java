...
/**
 * Uses operations on a set of two fractions and also models fractions using
...
public class Fraction {
	 ...
	 * 
	 * @return the return value is the fraction of the two fractions being added
	 *         together
	 * 
	 */
	 ...
	 * 
	 * @param input other fraction item
	 * @return the return value is the fraction of the two fractions being
	 *         subtracted together
	 * 
	 */
	 ...
	 * @param input other fraction item
	 * 
	 * @return the return value is the fraction of the two fractions being divided
	 *         together
	 * 
	 */
